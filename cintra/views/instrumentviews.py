...
class InstrumentViews(object):
    ...
    @view_config(name='add_instrument', context=InstrumentFolder, renderer="cintra:templates/edit_instrument.pt", permission='add_instrument')
    ...
    @view_config(name='edit', context=Instrument, renderer='cintra:templates/edit_instrument.pt', permission='add_instrument')
    ...
    @view_config(name='buy', context=Instrument, renderer='cintra:templates/edit_order.pt', permission='buy')
    ...
    @view_config(name='sell', context=Instrument, renderer='cintra:templates/edit_order.pt', permission='sell')
